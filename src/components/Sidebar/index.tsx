...
const Sidebar = () => {
  return (
    <aside className='h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80'>
      <div className='bg-white h-full rounded-2xl dark:bg-gray-700'>
        <div className='flex items-center justify-center pt-6 text-cyan-50 text-lg'>
          Rắc Rối Shop
        </div>
        <nav className='mt-6'>
          <div>
            ...
            <Link href='/cart'>
              <div className='w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500 cursor-pointer'>
            ...
            <a
              ...
              <span className='mx-4 text-sm font-normal'>Sản phẩm</span>
            </a>
            <a
              className='w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500'
              href='#'>
